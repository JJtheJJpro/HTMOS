...
ld -m elf_i386 -T linker.ld build/stage2.o target/i386-unknown-none/release/libbootloader_bios.a -o build/stage2.bin --oformat binary --gc-sections -Map=build/output.map
